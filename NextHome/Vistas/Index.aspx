<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="NextHome.Vistas.Index" %>
...
================================================== -->
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" type="../Recursos/image/x-icon" href="images/favicon.png" />
    <!-- PLUGINS CSS STYLE -->
    <link rel="stylesheet" href="../Recursos/plugins/bootstrap/bootstrap.min.css">
    <link rel="stylesheet" href="../Recursos/plugins/themify-icons/themify-icons.css">
    <link rel="stylesheet" href="../Recursos/plugins/slick/slick.css">
    <link rel="stylesheet" href="../Recursos/plugins/slick/slick-theme.css">
    <link rel="stylesheet" href="../Recursos/plugins/fancybox/jquery.fancybox.min.css">
    <link rel="stylesheet" href="../Recursos/plugins/aos/aos.css">
    <!-- CUSTOM CSS -->
            ...
            <nav class="navbar main-nav navbar-expand-lg px-2 px-sm-0 py-2 py-lg-0">
                <div class="container">
                    <a class="navbar-brand" href="index.html">
                        <img src="../Recursos/images/logo.png" alt="logo"></a>
                ...
                <div class="container">
					...
					showcase your App.
                        ...
                        <div class="col-md-6 text-center order-1 order-md-2">
                            <img class="img-fluid" src="../Recursos/images/mobile.png" alt="screenshot">
                        </div>
                    </div>
                </div>
            </section>
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-6 mt-5 mt-md-0 text-center">
                                ...
                                <p class="regular text-muted">
                                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Aliquam non, recusandae
                    ...
                    <div class="row">
                        <div class="col-lg-6 ml-auto justify-content-center">
                            ...
                            <div class="image-content" data-aos="fade-right">
                                <img class="img-fluid" src="../Recursos/images/feature/feature-new-01.jpg" alt="iphone" />
                            </div>
                        </div>
						...
						place."
                                ...
                                <ul class="list-inline meta">
                                    <li class="list-inline-item">
                                        <img src="../Recursos/images/testimonial/feature-testimonial-thumb.jpg" alt="">
                                    </li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 mr-auto justify-content-center">
                            ...
                            <div class="image-content" data-aos="fade-left">
                                <img class="img-fluid" src="../Recursos/images/feature/feature-new-02.jpg" alt="ipad">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="section-title">
                                ...
                                <p>
                                    <a href="https://themefisher.com/products/small-apps-free-app-landing-page-template/">Small Apps</a> makes
						it easy to stay on top of your Life Style. No late tasks. No gimmicks.
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="row no-gutters">
                        <div class="col-lg-6 align-self-center">
                            ...
                            <div class="service-thumb left" data-aos="fade-right">
                                <img class="img-fluid" src="../Recursos/images/feature/iphone-ipad.jpg" alt="iphone-ipad">
                            </div>
                        </div>
...
==================================-->
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="testimonial-slider owl-carousel owl-theme">
								...
								pretium ut lacinia in, elementum id enim.
                                        ...
                                        <!-- Person Thumb -->
                                        <div class="image">
                                            <img src="../Recursos/images/testimonial/feature-testimonial-thumb.jpg" alt="image">
                                        </div>
                                        <!-- Name and Company -->
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <p>
                                Download over 2 million humans .Get <a href="https://themefisher.com/products/small-apps-free-app-landing-page-template/">Small Apps</a> free forever!
    ...
    <script src="../Recursos/plugins/bootstrap/bootstrap.min.js"></script>
    <script src="../Recursos/plugins/slick/slick.min.js"></script>
    <script src="../Recursos/plugins/fancybox/jquery.fancybox.min.js"></script>
    <script src="../Recursos/plugins/syotimer/jquery.syotimer.min.js"></script>
    <script src="../Recursos/plugins/aos/aos.js"></script>
    <!-- google map -->
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAgeuuDfRlweIs7D6uo4wdIHVvJ0LonQ6g"></script>
    <script src="../Recursos/plugins/google-map/gmap.js"></script>
